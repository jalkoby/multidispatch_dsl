...
If you know another to Ruby programming languages, you probably know multi dispatch feature - define method with
different number of arguments of different types. In Ruby with it duck typing you cannot do it from out box. This
